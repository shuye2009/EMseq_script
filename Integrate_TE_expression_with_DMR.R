...
expression_dir <- "C:/PROJECTS/Shane/RNAseq/20250604_LH00244_0317_A22WFMGLT3_Harding_Shreya_RNAseq/results_TE/deseq2/single_factor_analysis_TE_transcript/"
# Read BED file and create GRanges object
centromere_bed <- read.table("C:/PROJECTS/resource/GRCh38_centromere_UCSC_simplified.bed", 
...
# Define consistent color palette for TE classes (13 classes)
te_class_colors <- c(
    "LINE" = "#E74C3C",        # Red
    "SINE" = "#3498DB",        # Blue
    "LTR" = "#2ECC71",         # Green
...
ggsave(class_plot, file = file.path(base_dir, "TE_class_transcript_count.pdf"), width = 6, height = 8)
ggsave(class_plot, file = file.path(base_dir, "TE_class_transcript_count.png"), width = 6, height = 8, dpi = 300)

# get TE annotation
annotation_dir <- "C:/PROJECTS/resource"
te_annotation <- read_tsv(file.path(annotation_dir, "GRCh38_GENCODE_rmsk_TE_annotated_ChIPseeker.tsv"))
head(te_annotation)
